...
const { findDOMNode, unstable_renderSubtreeIntoContainer } = require('react-dom')
...
let Autocomplete = React.createClass({
  ...
  componentDidMount() {
    ...
    this._mountNode.className = 'autoCompletePortal'
    const body = document.getElementsByTagName('body')[0]
    body.appendChild(this._mountNode)
    this.renderPortal()
  ...
  renderPortal() {
    console.log('Whats this node ' + this._mountNode)
     console.log('Whats this classname ' + this._mountNode.className)
    this.portal = unstable_renderSubtreeIntoContainer(this,
      this.renderMenu(), this._mountNode)
  },
